        ...
        <div class="hero-content flex-col lg:flex-row-reverse">
            <div class="text-center">
                <div class="flex justify-center">
                    <svg version="1.1" id="svg2" width="120" height="150" viewBox="0 0 300.00003 240.57818"
                ...
                <h1 class="text-xl md:text-4xl font-bold">Kawalin UT</h1>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem amet reiciendis quia officiis cumque!
                </p>
            </div>
                    ...
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select" name="kab_kota">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="input" name="no_hp" placeholder="No Hp"
                                    value="{{ old('no_hp') }}" />
                                @error('no_hp')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="flex items-baseline">
                            ...
                            <div><a class="link link-hover ms-2" href="{{ route('login') }}">Login Disini</a></div>
                        </div>
                    </form>
                </div>
            </div>

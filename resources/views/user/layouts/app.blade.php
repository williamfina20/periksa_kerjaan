...
<body>
    <div class="navbar bg-base-100 shadow-sm sticky top-0 z-50">
        <div class="navbar-start">
            <div class="dropdown">
                ...
                <ul tabindex="0"
                    ...
                    <li><a href="{{ route('user.beranda') }}"
                            class="{{ request()->routeIs('user.beranda') ? 'font-bold' : '' }}">Beranda</a>
                    </li>
                    <li><a href="{{ route('user.mahasiswa') }}"
                            class="{{ request()->routeIs('user.mahasiswa') ? 'font-bold' : '' }}">Mahasiswa</a>
                    </li>
                    <li><a href="{{ route('user.progress') }}"
                            class="{{ request()->routeIs('user.progress') ? 'font-bold' : '' }}">Progress</a>
                    </li>
                    <li>
                        <a>Parent</a>
                        <ul class="p-2">
            ...
            <a class="btn btn-ghost text-xl" href="{{ route('user.beranda') }}">Kawalin UT
                <svg version="1.1" id="svg2" width="40" height="50" viewBox="0 0 300.00003 240.57818"
                    ...
                    <g id="g8" inkscape:groupmode="layer"
                        inkscape:label="Logo_Universitas_Terbuka_dan_Warna_GSM_UT_2010"
                        transform="matrix(1.3333333,0,0,-1.3333333,-152.81652,640.90537)">
                        <g id="g176" clip-path="url(#clipPath180)" transform="translate(-32.104351,32.104351)">
                            <g id="g407" transform="matrix(0.80320208,0,0,0.80320208,31.738692,66.073712)">
                                <g id="g194" transform="translate(225.7458,369.8801)">
                                    <path
                                ...
                                <g id="g198" transform="translate(286.25349,309.37669)">
                                    <path
                                ...
                                <g id="g202" transform="translate(210.6963,307.127)">
                                    <path
                                ...
                                <g id="g206" transform="translate(359.11929,307.5968)">
                                    <path
                                ...
                                <g id="g210" transform="translate(418.28709,258.6877)">
                                    <path
                                ...
                                <g id="g214" transform="translate(418.28709,258.6877)">
                                    <path
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1">
                ...
                <li><a href="{{ route('user.mahasiswa') }}"
                        class="{{ request()->routeIs('user.mahasiswa', 'user.mahasiswa.*') ? 'font-bold' : '' }}">Mahasiswa</a>
                </li>
                <li><a href="{{ route('user.progress') }}"
                        class="{{ request()->routeIs(['user.progress', 'user.progress.*']) ? 'font-bold' : '' }}">Progress</a>
                </li>
                <li>
                    <details>
        ...
        <div class="navbar-end">
            <div class="dropdown dropdown-end">
                ...
                <ul tabindex="0"
                    ...
                    <div class="mx-auto font-bold my-2">{{ Auth()->user()->name }}</div>
                    <hr />
                    <li>
                        <a class="justify-between py-2 my-1" href="{{ route('profile.edit') }}">
                            Profile
                        </a>
                    </li>
                    <form action="{{ route('logout') }}" method="post">
                        <li>
                            ...
                            <button class="btn btn-error  btn-sm text-white"
                                onclick="return confirm('Yakin ingin keluar?')">Logout

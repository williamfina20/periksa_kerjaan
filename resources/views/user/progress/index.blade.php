            ...
            <div class="card card-border bg-base-100 w-full shadow">
                <div class="card-body">
                    <div class="flex justify-between">
                        ...
                        <a href="{{ route('user.progress.create') }}" class="btn btn-primary">Tambah
                            ...
                            <tbody>
                                @foreach ($progress as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('user.progress.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{ route('user.progress.edit', $item->id) }}"

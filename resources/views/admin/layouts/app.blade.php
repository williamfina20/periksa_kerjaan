        ...
        <div class="navbar-start">
            <div class="dropdown">
                ...
                <ul tabindex="0"
                    ...
                    <li><a href="{{ route('admin.beranda') }}"
                            class="{{ request()->routeIs('admin.beranda') ? 'font-bold' : '' }}">Beranda</a>
                    </li>
                    <li><a href="{{ route('admin.pengguna') }}"
                            class="{{ request()->routeIs('admin.pengguna') ? 'font-bold' : '' }}">Pengguna</a></li>
                    <li>
                    <li><a href="{{ route('admin.mahasiswa') }}"
                            class="{{ request()->routeIs('admin.mahasiswa') ? 'font-bold' : '' }}">Mahasiswa</a></li>
                    <li><a href="{{ route('admin.progress') }}"
                            class="{{ request()->routeIs('admin.progress') ? 'font-bold' : '' }}">Progress</a></li>
                    <li>
                        <a>Parent</a>
                        <ul class="p-2">
                            <li><a>Submenu 1</a></li>
            ...
            <a class="btn btn-ghost text-xl" href="{{ route('admin.beranda') }}">Kawalin UT
